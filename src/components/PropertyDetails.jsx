...
const PropertyDetails = ({ property, onClose }) => {
    ...
    useEffect(() => {
        ...
        // Handle Modal Setup (Escape key, body scroll lock)
    ...
    const handleFavoriteToggle = () => {
        ...
        // State update happens via the 'favoritesUpdated' event listener
    };
    ...
    return (
        ...
        <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center animate-fade-in" onClick={onClose}>
            {/* Modal Content */}
            <div 
                className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto transform scale-100 animate-slide-up transition-all duration-300"
            ...
            >
                ...
                <div className="relative">
                    ...
                    {/* Thumbnail Gallery */}
                    <div className="flex space-x-2 p-4 overflow-x-auto bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
...
export default PropertyDetails;// src/components/PropertyDetails.jsx
